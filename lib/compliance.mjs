...
export const RULES = [
  ...
  {
    id: 'publisher-independence',
    test: /\b(?:independent (?:review publication|publication|review roster)|independent third-party review publication)\b/i,
    exemptOnNegation: true,
    message: 'Publisher shares ownership with Peptriva. Describe the affiliation accurately.',
  },
];
