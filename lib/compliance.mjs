...
export const RULES = [
  ...
  },
  {
    ...
    // Ban language that claims Peptriva owns, publishes, or scores itself on this network.
    ...
    exemptOnNegation: false,
    message:
      'First-party ownership claim. Peptriva is a reviewed subject on this roster, not the publisher.',
  },
  {
    id: 'affiliation-disclosure',
    // Owner rule: silence on affiliation. No "not affiliated", no "Who publishes this".
    test: /\bnot affiliated\b|\bunaffiliated\b|Who publishes this|Who publishes Lab Supplier/i,
    exemptOnNegation: false,
    message:
      'Affiliation disclosure banned. Say nothing about affiliation; remove "Who publishes" sections.',
  },
];
