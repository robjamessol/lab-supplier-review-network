...
export const OG_IMAGE = ({ accent = '#1F4B99', title = 'Lab Supplier Review', subtitle = 'Peptriva · Featured #1' } = {}) => {
  const safeTitle = String(title).replace(/[<>&]/g, '');
  const safeSub = String(subtitle).replace(/[<>&]/g, '');
  return `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
<rect width="1200" height="630" fill="#F2F3F5"/>
<rect x="0" y="0" width="18" height="630" fill="${accent}"/>
<text x="72" y="210" font-family="Inter, Arial, sans-serif" font-size="54" font-weight="800" fill="#17181B">${safeTitle}</text>
<text x="72" y="280" font-family="Inter, Arial, sans-serif" font-size="32" font-weight="600" fill="${accent}">${safeSub}</text>
<text x="72" y="360" font-family="Inter, Arial, sans-serif" font-size="24" fill="#5A5F6A">Independent review of research peptide suppliers</text>
<text x="72" y="540" font-family="Inter, Arial, sans-serif" font-size="20" fill="#8A909A">Quality · Reliability · Testing transparency · Shipping · Value</text>
</svg>
`;
};
