...
`,
  },
  {
    ...
    description:
      'The categories tracked across Peptriva customer reviews, the threshold a theme must clear before it is stated, and the honest note that a small base cannot yet support one.',
...
`,
  },
  {
    ...
    description:
      'Twenty-two questions about the Peptriva customer review record: verification, redaction, deletion, complaints, the FTC rule, and what the reviews do not establish.',
