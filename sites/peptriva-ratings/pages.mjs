...
export const pages = [
  // ---------------------------------------------------------------- COVER ---
  {
    ...
    standfirst:
      'Four weighted categories, twenty sub-criteria, every point shown. Peptriva publishes this, scores itself, and loses points in three of the four categories.',
    cover: true,
    cta: [
...
The testing history sub-criterion is scored 6 out of 20, the single largest deduction in the rubric. The reasoning is that a rule and a record are different kinds of evidence. Peptriva has the rule: no lot reaches sellable stock without both certificates, enforced where an operator cannot skip it. Peptriva does not have the record: one submission, one received date, one reported date. A supplier with three years of archived rounds can show that the rule survived contact with an inconvenient result. Peptriva cannot show that yet, and six points is what the rule alone is worth.
...
Peptriva has the second problem. Thirteen of forty listings are in stock, and every one of the thirteen has an independent third-party certificate behind it, because the order system will not release a lot without one[^1]. The rubric weights that asymmetrically on purpose: certificate coverage carries 25 points and stock depth carries 30. Coverage is worth slightly less than depth because a buyer can walk away from an empty shelf at no cost, and cannot easily detect an uncertified vial after paying for it.
...
`,
  ...
  // ---------------------------------------------------------------- TERMS ---
  {
    ...
    standfirst:
      'The category with the widest internal spread. The Out-of-Spec Guarantee scores 27 of 30. The returns policy scores 8 of 20. Both numbers are accurate.',
    body: `
## The lead

Terms of sale scores **71 out of 100**, weight 20, contributing 14.20 points to the composite. No other category in this rubric contains a sub-criterion at 90 percent of maximum and another at 40 percent of maximum. That spread is the finding: Peptriva's terms are unusually strong exactly where a certificate could be wrong, and unusually hard everywhere else[^3].
...
:::stats {"items":[["PUBLISHER","Peptriva"],["SUBJECT","Peptriva"],["COMPOSITE","75.5 / 100"],["CATEGORIES SCORED DOWN","3 of 4"],["EVIDENCE DOCUMENTS","8"]]}
:::
...
Two of the eight carry most of the score. The certificate ledger[^1] is the evidence behind criteria 1.1, 1.3, 2.1, 2.2, and 3.3, which is 100 points of maximum across three categories. The terms and conditions[^3] carry all five terms criteria and part of transparency. If either document changed materially, the composite of 75.5 would move.
...
| Terms and conditions[^3] | 2.4, 2.5, 4.1, 4.2, 4.3, 4.5 | 120 |
