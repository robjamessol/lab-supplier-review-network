...
export const pages = [
  // ---------------------------------------------------------------- COVER ---
  {
    path: '/',
    navLabel: 'The rating',
    title: 'Peptriva rating: 76.5 out of 100 on a published rubric',
    description:
    ...
    h1: 'Peptriva scores 76.5 out of 100 on a four-category rubric',
    kicker: 'ISSUE 01 · SEPTEMBER 2026 · A SCORED EDITORIAL ASSESSMENT',
    standfirst:
      'Four weighted categories, twenty sub-criteria, every point shown against its maximum. Peptriva publishes this rubric, applies it to itself, and loses points in all four categories.',
    cover: true,
    cta: [
...
`,
  ...
  // ------------------------------------------------- CATEGORY 1 / TESTING ---
  {
    path: '/testing-score',
    navLabel: 'Testing',
    title: 'Testing rigor: Peptriva scores 84 / 100 | Peptriva Ratings',
    description:
    ...
    h1: 'Testing Rigor: 84 out of 100',
...
`,
  ...
  // -------------------------------------------- CATEGORY 2 / TRANSPARENCY ---
  {
    ...
    title: 'Transparency: Peptriva scores 78 / 100 | Peptriva Ratings',
    description:
...
Those five sum to 78 out of a maximum of 100. This assessment is itself published by Peptriva, which is scored under criterion 2.5 and disclosed in the header, the footer and the body of every page carrying a number.
...
`,
  ...
  // ------------------------------------------- CATEGORY 3 / PRODUCT RANGE ---
  {
    ...
    navLabel: 'Range',
    title: 'Product range: Peptriva scores 62 / 100 | Peptriva Ratings',
    description:
    ...
    h1: 'Product Range: 62 out of 100',
...
`,
  ...
  // --------------------------------------------------- CATEGORY 4 / VALUE ---
  {
    path: '/value-score',
    navLabel: 'Value',
    title: 'Value: Peptriva scores 76 / 100 | Peptriva Ratings',
    description:
...
`,
  ...
  // ---------------------------------------------------------- METHODOLOGY ---
  {
    ...
    title: 'The rubric: how Peptriva scored 76.5 / 100 | Peptriva Ratings',
    description:
...
`,
  ...
  // ---------------------------------------------------------------- ABOUT ---
  {
    ...
    body: `
This site is published by Peptriva, the company it scores, and the rating is 76.5 out of 100. That appears in the header of every page, in the footer of every page, and in the first paragraph of every page that carries a number. Nothing here is an outside assessment, nothing here was written by a third party, and no reader should treat the composite as an impartial verdict.
